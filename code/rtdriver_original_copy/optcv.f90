...
!  CO2V       - Visible CO2 k-coefficients 
!  PLEV       - Pressures at each level
!  PFGASREF   - Fine grid pressure grid 
!  TGASREF    - Temperature grid for copacities
!  QXVDST     - Qext for dust
!  QSVDST     - Qscat for dust
!  GVDST      - g (scattering asymmetry) for dust
!  WBARV      - total scattering albedo
!  COSBV      - total scattering asymmetry
!  TAURAY     - Rayleigh scattering optical depth
...
!  TAUGSURF   - Gas optical depth (from top of atmosphere to the surface)
...
!  QXVCLD     - Qext for water ice clouds
!  QSVCLD     - Qscat for water ice clouds
!  GVCLD      - g (scattering asymmetry) for clouds
!
!----------------------------------------------------------------------C
