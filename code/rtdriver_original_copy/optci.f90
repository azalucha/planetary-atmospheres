...
!  TAUI       - IR opacity from top of the atmosphere to bottom
!               of layer L.
!  TAUCUMI    - Cumulative optical depth, top of atmosphere to
!               the bottom of each layer.
!  PLEV(L)    - Pressure at the layer boundary (i.e. level)
!  CO2I       - IR CO2 k-coefficients 
!  PLEV       - Pressures at each level
!  PFGASREF   - Fine grid pressure grid 
!  TGASREF    - Temperature grid for copacities
!  QXIDST     - Qext for dust
!  QSIDST     - Qscat for dust
!  GIDST      - g (scattering asymmetry) for dust
!  WBARI      - total scattering albedo
!  COSBI      - total scattering asymmetry
!  TAUREF     - Dust optical depth in each layer, at the reference 
!               wavelength (0.67 microns)
!  TMID       - Temperature at the layer mid-point
!  PMID       - Pressure at the layer mid-point
!  TAUGSURF   - Gas optical depth (from top of atmosphere to the
!               surface)
!  QH2O       - Water mixing ratio
!  WREFH2O    - Grid of water amounts
!  QEXTREFCLD - Qext for clouds at the reference wavelength
!  TAUREFCLD  - Cloud optical depth at the reference wavelength
!  QXICLD     - Qext for water ice clouds
!  QSICLD     - Qscat for water ice clouds
!  GICLD      - g (scattering asymmetry) for clouds
!
!----------------------------------------------------------------------C
