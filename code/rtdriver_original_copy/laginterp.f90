...
!  PGREF   - Pressure grid on which k-coefficients were computed.
!  PINT    - Interpolated pressure grid (finer grid spacing than 
!            PGREF)
!  CO2I    - CO2 IR k-coefficients on interpolated grid
!  CO2V    - CO2 visible k-coefficients on interpolated grid
!  FZEROI  - Fraction of zeros in each IR spectral interval
!  FZEROV  - Fraction of zeros in each visible spectral interval
!
!----------------------------------------------------------------------!
